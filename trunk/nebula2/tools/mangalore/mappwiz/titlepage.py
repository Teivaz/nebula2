...
class TitledPage(wiz.WizardPageSimple):
    def __init__(self, parent, title):
        ...
        title = """
The Mangalore Application Wizard helps you to write your own application \
which uses mangalore::application module. 
...
source files. The Mangalore Appplication Wizard provides several pages and \
each of the pages contains settings for the task.
The classes which are generated by the Mangalore Application Wizard are derived \
from Application::App and Application::StateHandler (or a derived class). \
You can change the names and settings by the controls on the each of the pages.
Enjoy!

(C)2006 Kim, Hyoun Woo / Anthony Whitaker
(C)2005 Kim, Hyoun Woo"""
        ...
        self.titleTextCtrl.SetStyle(0, 33, wx.TextAttr("BLACK", wx.NullColour, fnt))
