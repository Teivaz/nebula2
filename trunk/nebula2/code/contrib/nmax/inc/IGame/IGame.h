...
//	virtual Matrix3 GetWorldTM(TimeValue t=TIME_NegInfinity)=0;
	...
	*/
	...
	//!Is the node hidden
	/*!This allows access to the hidder property of the node.  A developer may choose to ignore any node that is hidden.  However
...
class IGameScene
{
	public:
		...
		*/
		...
		//!Initialise IGame with a specifc node.  
		...
		*/
		...
		//!Initialise IGame with a specifc set of nodes.  
		...
		*/
		...
		/*! The is usuful if you want to use a progress bar in the exporter
		\return The totol node count
		*/
