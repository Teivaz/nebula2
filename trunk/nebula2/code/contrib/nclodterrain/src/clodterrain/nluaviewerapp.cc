...
//------------------------------------------------------------------------------
#include "luaviewer/nluaviewerapp.h"
...
/**
*/
nLuaViewerApp::nLuaViewerApp(nKernelServer* ks) :
    kernelServer(ks),
    isOpen(false),
    controlMode(Maya),
...
*/
void
nLuaViewerApp::TransferGlobalVariables()
{
...
*/
void
nLuaViewerApp::DefineInputMapping()
{
...
*/
void
nLuaViewerApp::HandleInputMaya(float frameTime)
{
    nInputServer* inputServer = this->refInputServer.get();
...
*/
void
nLuaViewerApp::HandleInputFly(float frameTime)
{
    nInputServer* inputServer = this->refInputServer.get();
    if (frameTime <= 0.0001f)
    {
