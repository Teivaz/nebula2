...
public:
    ...
    void SetFile(nFile* file);
    /// get alternative shared nFile object pointing to .chu file
    nFile* GetFile() const;
...
//------------------------------------------------------------------------------
/**
    Set alternative nFile pointer to an already open .chu file.
*/
inline
void
nChunkLodMesh::SetFile(nFile* file)
{
