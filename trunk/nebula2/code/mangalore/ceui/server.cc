...
*/
void Server::DestroyWindow(const nString& winName) {
    CEGUI::WindowManager::getSingleton().destroyWindow(winName.Get());
}
...
/**
    set root window
*/
void Server::SetRootWindow(CEGUI::Window* window) {
    n_assert(window != NULL);
