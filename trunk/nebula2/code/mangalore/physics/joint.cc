...
namespace Physics
{
ImplementRtti(Physics::Joint, Foundation::RefCounted);
...
*/
void
Joint::Attach(dWorldID worldID, dJointGroupID groupID, const matrix44& m)
{
...
*/
void
Joint::UpdateTransform(const matrix44& m)
{
    // empty
}
