...
/**
    ...
    emitters in the world. Takes care of updating them, the rendering is a
...
class nParticleServer : public nRoot
{
private:
...
private:
    ...
    nWatched numDrawnPrimitives;    ///< number of primitives consumed by the particle drawing
    #endif    
};
