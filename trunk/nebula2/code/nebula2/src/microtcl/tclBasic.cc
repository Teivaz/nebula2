...
static CmdInfo builtInCmds[] = {
    ...
    {"append",      (Tcl_CmdProc *) NULL,   Tcl_AppendObjCmd,       (CompileProc *) NULL,       1},
    {"array",       (Tcl_CmdProc *) NULL,   Tcl_ArrayObjCmd,        (CompileProc *) NULL,       1},
//    {"binary",      (Tcl_CmdProc *) NULL,   Tcl_BinaryObjCmd,       (CompileProc *) NULL,       1},
    {"break",       (Tcl_CmdProc *) NULL,   Tcl_BreakObjCmd,        TclCompileBreakCmd,     1},
    {"case",        (Tcl_CmdProc *) NULL,   Tcl_CaseObjCmd,         (CompileProc *) NULL,       1},
//    {"catch",       (Tcl_CmdProc *) NULL,   Tcl_CatchObjCmd,        TclCompileCatchCmd,     1},
//    {"clock",       (Tcl_CmdProc *) NULL,   Tcl_ClockObjCmd,        (CompileProc *) NULL,       1},
    {"concat",      (Tcl_CmdProc *) NULL,   Tcl_ConcatObjCmd,       (CompileProc *) NULL,       1},
    {"continue",    (Tcl_CmdProc *) NULL,   Tcl_ContinueObjCmd,     TclCompileContinueCmd,      1},
//    {"encoding",    (Tcl_CmdProc *) NULL,   Tcl_EncodingObjCmd,     (CompileProc *) NULL,       0},
//    {"error",       (Tcl_CmdProc *) NULL,   Tcl_ErrorObjCmd,        (CompileProc *) NULL,       1},
    {"eval",        (Tcl_CmdProc *) NULL,   Tcl_EvalObjCmd,         (CompileProc *) NULL,       1},
//    {"exit",        (Tcl_CmdProc *) NULL,   Tcl_ExitObjCmd,         (CompileProc *) NULL,       0},
    {"expr",        (Tcl_CmdProc *) NULL,   Tcl_ExprObjCmd,         TclCompileExprCmd,      1},
//    {"fcopy",       (Tcl_CmdProc *) NULL,   Tcl_FcopyObjCmd,        (CompileProc *) NULL,       1},
//    {"fileevent",   (Tcl_CmdProc *) NULL,   Tcl_FileEventObjCmd,    (CompileProc *) NULL,       1},
    {"for",         (Tcl_CmdProc *) NULL,   Tcl_ForObjCmd,          TclCompileForCmd,       1},
    {"foreach",     (Tcl_CmdProc *) NULL,   Tcl_ForeachObjCmd,      TclCompileForeachCmd,       1},
//    {"format",      (Tcl_CmdProc *) NULL,   Tcl_FormatObjCmd,       (CompileProc *) NULL,       1},
    {"global",      (Tcl_CmdProc *) NULL,   Tcl_GlobalObjCmd,       (CompileProc *) NULL,       1},
    {"if",          (Tcl_CmdProc *) NULL,   Tcl_IfObjCmd,           TclCompileIfCmd,        1},
    {"incr",        (Tcl_CmdProc *) NULL,   Tcl_IncrObjCmd,         TclCompileIncrCmd,      1},
//    {"info",        (Tcl_CmdProc *) NULL,   Tcl_InfoObjCmd,         (CompileProc *) NULL,       1},
    {"join",        (Tcl_CmdProc *) NULL,   Tcl_JoinObjCmd,         (CompileProc *) NULL,       1},
    {"lappend",     (Tcl_CmdProc *) NULL,   Tcl_LappendObjCmd,      (CompileProc *) NULL,       1},
    {"lindex",      (Tcl_CmdProc *) NULL,   Tcl_LindexObjCmd,       (CompileProc *) NULL,       1},
    {"linsert",     (Tcl_CmdProc *) NULL,   Tcl_LinsertObjCmd,      (CompileProc *) NULL,       1},
    {"list",        (Tcl_CmdProc *) NULL,   Tcl_ListObjCmd,         (CompileProc *) NULL,       1},
    {"llength",     (Tcl_CmdProc *) NULL,   Tcl_LlengthObjCmd,      (CompileProc *) NULL,       1},
//    {"load",        (Tcl_CmdProc *) NULL,   Tcl_LoadObjCmd,         (CompileProc *) NULL,       0},
    {"lrange",      (Tcl_CmdProc *) NULL,   Tcl_LrangeObjCmd,       (CompileProc *) NULL,       1},
    {"lreplace",    (Tcl_CmdProc *) NULL,   Tcl_LreplaceObjCmd,     (CompileProc *) NULL,       1},
    {"lsearch",     (Tcl_CmdProc *) NULL,   Tcl_LsearchObjCmd,      (CompileProc *) NULL,       1},
    {"lsort",       (Tcl_CmdProc *) NULL,   Tcl_LsortObjCmd,        (CompileProc *) NULL,       1},
//    {"namespace",   (Tcl_CmdProc *) NULL,   Tcl_NamespaceObjCmd,    (CompileProc *) NULL,       1},
//    {"package",     (Tcl_CmdProc *) NULL,   Tcl_PackageObjCmd,      (CompileProc *) NULL,       1},
    {"proc",        (Tcl_CmdProc *) NULL,   Tcl_ProcObjCmd,         (CompileProc *) NULL,       1},
//    {"regexp",      (Tcl_CmdProc *) NULL,   Tcl_RegexpObjCmd,       (CompileProc *) NULL,       1},
//    {"regsub",      (Tcl_CmdProc *) NULL,   Tcl_RegsubObjCmd,       (CompileProc *) NULL,       1},
    {"rename",      (Tcl_CmdProc *) NULL,   Tcl_RenameObjCmd,       (CompileProc *) NULL,       1},
    {"return",      (Tcl_CmdProc *) NULL,   Tcl_ReturnObjCmd,       TclCompileReturnCmd,        1},
//    {"scan",        (Tcl_CmdProc *) NULL,   Tcl_ScanObjCmd,         (CompileProc *) NULL,       1},
    {"set",         (Tcl_CmdProc *) NULL,   Tcl_SetObjCmd,          TclCompileSetCmd,       1},
    {"split",       (Tcl_CmdProc *) NULL,   Tcl_SplitObjCmd,        (CompileProc *) NULL,       1},
    {"string",      (Tcl_CmdProc *) NULL,   Tcl_StringObjCmd,       TclCompileStringCmd,        1},
    {"subst",       (Tcl_CmdProc *) NULL,   Tcl_SubstObjCmd,        (CompileProc *) NULL,       1},
    {"switch",      (Tcl_CmdProc *) NULL,   Tcl_SwitchObjCmd,       (CompileProc *) NULL,       1},
//    {"trace",       (Tcl_CmdProc *) NULL,   Tcl_TraceObjCmd,        (CompileProc *) NULL,       1},
    {"unset",       (Tcl_CmdProc *) NULL,   Tcl_UnsetObjCmd,        (CompileProc *) NULL,       1},
//    {"uplevel",     (Tcl_CmdProc *) NULL,   Tcl_UplevelObjCmd,      (CompileProc *) NULL,       1},
//    {"upvar",       (Tcl_CmdProc *) NULL,   Tcl_UpvarObjCmd,        (CompileProc *) NULL,       1},
//    {"variable",    (Tcl_CmdProc *) NULL,   Tcl_VariableObjCmd,     (CompileProc *) NULL,       1},
    {"while",       (Tcl_CmdProc *) NULL,   Tcl_WhileObjCmd,        TclCompileWhileCmd,     1},
...
#ifndef TCL_GENERIC_ONLY
//    {"after",       (Tcl_CmdProc *) NULL,   Tcl_AfterObjCmd,        (CompileProc *) NULL,       1},
//    {"cd",          (Tcl_CmdProc *) NULL,   Tcl_CdObjCmd,           (CompileProc *) NULL,       0},
//    {"close",       (Tcl_CmdProc *) NULL,   Tcl_CloseObjCmd,        (CompileProc *) NULL,       1},
//    {"eof",         (Tcl_CmdProc *) NULL,   Tcl_EofObjCmd,          (CompileProc *) NULL,       1},
//    {"fblocked",    (Tcl_CmdProc *) NULL,   Tcl_FblockedObjCmd,     (CompileProc *) NULL,       1},
//    {"fconfigure",  (Tcl_CmdProc *) NULL,   Tcl_FconfigureObjCmd,   (CompileProc *) NULL,       0},
//    {"file",        (Tcl_CmdProc *) NULL,   Tcl_FileObjCmd,         (CompileProc *) NULL,       0},
//    {"flush",       (Tcl_CmdProc *) NULL,   Tcl_FlushObjCmd,        (CompileProc *) NULL,       1},
//    {"gets",        (Tcl_CmdProc *) NULL,   Tcl_GetsObjCmd,         (CompileProc *) NULL,       1},
//    {"glob",        (Tcl_CmdProc *) NULL,   Tcl_GlobObjCmd,         (CompileProc *) NULL,       0},
//    {"open",        (Tcl_CmdProc *) NULL,   Tcl_OpenObjCmd,         (CompileProc *) NULL,       0},
//    {"pid",         (Tcl_CmdProc *) NULL,   Tcl_PidObjCmd,          (CompileProc *) NULL,       1},
//    {"puts",        (Tcl_CmdProc *) NULL,   Tcl_PutsObjCmd,         (CompileProc *) NULL,       1},
//    {"pwd",         (Tcl_CmdProc *) NULL,   Tcl_PwdObjCmd,          (CompileProc *) NULL,       0},
//    {"read",        (Tcl_CmdProc *) NULL,   Tcl_ReadObjCmd,         (CompileProc *) NULL,       1},
//    {"seek",        (Tcl_CmdProc *) NULL,   Tcl_SeekObjCmd,         (CompileProc *) NULL,       1},
//    {"socket",      (Tcl_CmdProc *) NULL,   Tcl_SocketObjCmd,       (CompileProc *) NULL,       0},
//    {"tell",        (Tcl_CmdProc *) NULL,   Tcl_TellObjCmd,         (CompileProc *) NULL,       1},
//    {"time",        (Tcl_CmdProc *) NULL,   Tcl_TimeObjCmd,         (CompileProc *) NULL,       1},
//    {"update",      (Tcl_CmdProc *) NULL,   Tcl_UpdateObjCmd,       (CompileProc *) NULL,       1},
//    {"vwait",       (Tcl_CmdProc *) NULL,   Tcl_VwaitObjCmd,        (CompileProc *) NULL,       1},

#ifdef MAC_TCL
//    {"beep",        (Tcl_CmdProc *) NULL,   Tcl_BeepObjCmd,         (CompileProc *) NULL,       0},
//    {"echo",        Tcl_EchoCmd,            (Tcl_ObjCmdProc *) NULL,    (CompileProc *) NULL,       0},
//    {"ls",          (Tcl_CmdProc *) NULL,   Tcl_LsObjCmd,           (CompileProc *) NULL,       0},
//    {"resource",    (Tcl_CmdProc *) NULL,   Tcl_ResourceObjCmd,     (CompileProc *) NULL,       1},
//    {"source",      (Tcl_CmdProc *) NULL,   Tcl_MacSourceObjCmd,    (CompileProc *) NULL,       0},
#else
//    {"exec",        (Tcl_CmdProc *) NULL,   Tcl_ExecObjCmd,         (CompileProc *) NULL,       0},
    {"source",      (Tcl_CmdProc *) NULL,   Tcl_SourceObjCmd,       (CompileProc *) NULL,       0},
#endif /* MAC_TCL */

#endif /* TCL_GENERIC_ONLY */
    {NULL,      (Tcl_CmdProc *) NULL,   (Tcl_ObjCmdProc *) NULL,    (CompileProc *) NULL,       0}
};
