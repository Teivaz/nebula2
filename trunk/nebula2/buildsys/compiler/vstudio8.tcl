...
proc gen_sln { name } {
    ...
    puts $cid "Microsoft Visual Studio Solution File, Format Version 9.00"
    puts $cid "# Visual C++ Express 2005"
    ...
    puts $cid "Global"
    puts $cid "\tGlobalSection(SolutionConfigurationPlatforms) = preSolution"
    puts $cid "\t\tDebug|Win32 = Debug|Win32"
    puts $cid "\t\tRelease|Win32 = Release|Win32"
    ...
    foreach target [get_targets] {
        ...
        puts $cid "\t\t{$targetuuids($target)}.Debug|Win32.Build.0 = Debug|Win32"
        puts $cid "\t\t{$targetuuids($target)}.Release|Win32.ActiveCfg = Release|Win32"
        puts $cid "\t\t{$targetuuids($target)}.Release|Win32.Build.0 = Release|Win32"
    }

    puts $cid "\tEndGlobalSection"
    puts $cid "\tGlobalSection(SolutionProperties) = preSolution"
    puts $cid "\t\tHideSolutionNode = FALSE"
    puts $cid "\tEndGlobalSection"
    puts $cid "EndGlobal"
...
proc generate { wslist } {
    ...
    set vstudiopath ./build/vstudio8
    set outputpath  ./bin
