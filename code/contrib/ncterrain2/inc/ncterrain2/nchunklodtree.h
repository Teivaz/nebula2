...
protected:
    ...
    /// get pointer to resource server
    nResourceServer* GetResourceServer();
...
inline
nResourceServer*
nChunkLodTree::GetResourceServer()
{
    return this->refResourceServer.get();
}
...
inline
void
nChunkLodTree::SetDisplayMode(const nDisplayMode2& mode)
{
