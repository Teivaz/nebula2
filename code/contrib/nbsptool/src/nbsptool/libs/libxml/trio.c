 ...
 * Trio include files
 */
#include "nbsptool/libs/libxml/triodef.h"
#include "nbsptool/libs/libxml/trio.h"
#include "nbsptool/libs/libxml/triop.h"
#include "nbsptool/libs/libxml/trionan.h"
#if !defined(TRIO_MINIMAL)
# include "nbsptool/libs/libxml/triostr.h"
#endif
