...
main(int argc, const char** argv)
{
    ...
    kernelServer.AddPackage(luatest);

    nScriptServer* scriptServer = (nScriptServer*) kernelServer.New("nluaserver", "/sys/servers/script");
    if (0 == scriptServer)
    {
