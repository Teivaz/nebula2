...
public:
    ...
    /// build an UPDATE statement from the given data, fails if requested colums does not exist
    void BuildUpdateStatement();
    /// build an DELETE statement from the given data, fails if requested colums does not exist
