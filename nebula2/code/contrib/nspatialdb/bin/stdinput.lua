...
-- manipulate state; which camera is active, etc.
    ...
    i:map('keyb0:f3.down',          'cyclecontrolcamera')
    i:map('keyb0:f4.down',          'cycleviscamera')
    i:map('keyb0:f5.down',          'togglesphere')
    i:map('keyb0:f6.down',          'cycleviewcamera')
    i:map('keyb0:f7.down',          'togglefrustum')
    i:map('keyb0:f8.down',          'otherview')
