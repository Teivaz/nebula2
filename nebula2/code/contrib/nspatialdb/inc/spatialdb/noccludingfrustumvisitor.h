...
/**
   ...
   @brief Visits all elements visible in a view frustum, factoring in occluder objects.
   ...
   projective camera.  The difference between this class and its superclass (nVisibleFrustumVisitor)
