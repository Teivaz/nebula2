#ifndef BB_FREECAMERA_H
#define BB_FREECAMERA_H
//------------------------------------------------------------------------------
/**
    @class BBFreeCamera
    ...
    A BBFreeCamera keeps track only of its own position and orientation.
...
class BBFreeCamera : public BBCamera
{
public:
	enum SpinMode 
