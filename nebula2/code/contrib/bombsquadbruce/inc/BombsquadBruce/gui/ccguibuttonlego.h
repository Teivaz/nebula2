...
/**
    ...
    of an nGuiButtonLego (used for e.g. determining when the mouse is over 
    ...
    "virtual button", all the nGuiButtonLegos will be highlighted.
...
//-----------------------------------------------------------------------------
class CCGuiButtonLego : public nGuiButton
{
public:
    /// constructor
    CCGuiButtonLego();
    /// destructor
    virtual ~CCGuiButtonLego();
    /// is position inside?
