...
/**
    ...
    bloat, I didn't create a BBPlayer subclass.  A more complex game, say with
    computer controlled animals walking around, would derive BBPlayer and
    BBAnimal, and move much of the functionality below into the former.
...
//------------------------------------------------------------------------------
class BBMobileActor : public BBActor
{
public:
    BBMobileActor();
    ~BBMobileActor();
