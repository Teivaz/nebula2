...
/**
    ...
    @classinfo
    CCCamera links named user input channels to camera movement instructions.
    How the instructions are interpreted depends on which kind of CCCamera
    subclass is in use.
*/
void
...
*/
bool
CCCamera::SaveCmds(nPersistServer* ps)
{
