...
//------------------------------------------------------------------------------
#include "BombsquadBruce/bbshapenode.h"
#include "gfx2/ngfxserver2.h"
#include "scene/nsceneserver.h"
#include "variable/nvariableserver.h"

nNebulaScriptClass(BBShapeNode, "nshapenode");

//------------------------------------------------------------------------------
BBShapeNode::BBShapeNode() :
...
//void BBShapeNode::SetFisheyeCentreVarName( const char* varName )
//{
...
*/
bool
BBShapeNode::RenderTransform(nSceneServer* sceneServer, 
