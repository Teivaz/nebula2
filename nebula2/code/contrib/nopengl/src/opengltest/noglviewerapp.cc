...
*/
void
nOGLViewerApp::ValidateRootNode()
{
...
nOGLViewerApp::Open()
{
    ...
    {
        n_error("nOGLViewerApp::Open(): Failed to open nSceneServer!");
        return false;
    }
...
*/
void
nOGLViewerApp::TransferGlobalVariables()
{
...
*/
void
nOGLViewerApp::HandleInput(float frameTime)
{
...
*/
void
nOGLViewerApp::DefineInputMapping()
{
...
*/
void
nOGLViewerApp::HandleInputMaya(float frameTime)
{
    nInputServer* inputServer = this->refInputServer.get();
...
*/
void
nOGLViewerApp::HandleInputFly(float frameTime)
{
    nInputServer* inputServer = this->refInputServer.get();
    if (frameTime <= 0.0001f)
    {
