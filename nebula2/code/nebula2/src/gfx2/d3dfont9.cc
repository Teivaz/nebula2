...
//-----------------------------------------------------------------------------
CD3DFont9::CD3DFont9( const TCHAR* strFontName, DWORD dwHeight, DWORD dwFlags )
{
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::CreateGDIFont( HDC hDC, HFONT* pFont )
{
...
//       will occur.
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::PaintAlphabet( HDC hDC, BOOL bMeasureOnly )
{
    SIZE size;
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::InitDeviceObjects( LPDIRECT3DDEVICE9 pd3dDevice )
{
    HRESULT hr = S_OK;
    HFONT hFont = NULL;
    HFONT hFontOld = NULL;
...
// Desc:
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::RestoreDeviceObjects()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::InvalidateDeviceObjects()
{
    SAFE_RELEASE( m_pVB );
...
// Desc: Destroys all device-dependent objects
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::DeleteDeviceObjects()
{
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::GetTextExtent( const TCHAR* strText, SIZE* pSize )
{
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::DrawTextScaled( FLOAT x, FLOAT y, FLOAT z,
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::DrawText( FLOAT sx, FLOAT sy, DWORD dwColor,
                            const TCHAR* strText, DWORD dwFlags )
{
    if( m_pd3dDevice == NULL )
        return E_FAIL;
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont9::Render3DText( const TCHAR* strText, DWORD dwFlags )
{
    if( m_pd3dDevice == NULL )
        return E_FAIL;
